...
action="<?php echo base_url() . "transaksi/addpost"; ?>" method="post">
   ...
   <?php } ?>
                   ...
                   <div class="form-group">
                     ...
                     <div class="col-sm-6">
                      <div class="input-group nama-petani">
                        <input type="text" placeholder="Pilih nama Petani" 
                  ...
                  <!-- <div class="form-group">
                     ...
                     <div class="col-sm-6">
                        ...
                        <input type="text" placeholder="Pilih Kode Kelompok" 
                   ...
                   <div class="form-group">
                    <label class="col-sm-3 control-label">Kode Kelompok Petani :</label>
                     <div class="col-sm-4">
                      <input id="kode" type="number" placeholder="Kode" required  
                       class="form-control" name="kode_kelompok" value="<?php echo $kode_kelompok;?>" >                    
                    </div>
                  </div>
              ...
              <div class="form-group">
               ...
               <div class="col-sm-6">
                <div class="input-group tarif">
                  ...
                  id="tarif" required  class="form-control" name="tarif" value="<?php echo $tarif;?>" 
                  readonly="true" >
                  <span class="input-group-addon"><i class="ti ti-book"></i></span>
...
<script>
  ...
  for(c=0,d='';c<b.length;c++){d+=b[c];if((c+1)%3===0&&c!==(b.length-1)){d+='.';}}return e(d)+',00'}
    ...
    $('.reset_form').on('click', function () {
     if(confirm('Apakah anda yakin untuk menghapus form ini??')){
      $(this).closest('#validate-form').find('input, text').val('');
      $('.btn-green').val('Simpan');
    }
  });
